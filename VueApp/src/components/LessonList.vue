<template>
  ...
  <div class="row">
    ...
    <div class="create-lesson col-6">
      <h2>Create New Lesson</h2>
      <form @submit.prevent="createLesson">
        <div>
          <label for="subject">Subject:</label>
          <input v-model="newLesson.subject" class="form-control" type="text" placeholder="Enter subject" required />
        </div>
        <div>
          <label for="location">Location:</label>
          <input v-model="newLesson.location" class="form-control" type="text" placeholder="Enter location" required />
        </div>
        <div>
          <label for="price">Price:</label>
          <input v-model="newLesson.price" class="form-control" type="number" placeholder="Enter price" required />
        </div>
        <div>
          <label for="spaces">Spaces:</label>
          <input v-model="newLesson.spaces" class="form-control" type="number" placeholder="Enter number of spaces" required />
        </div>
